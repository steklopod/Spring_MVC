...
<div class="container">
    <div class="row">
        ...
        <form:form modelAttribute="project" action="${formUrl }" method="post" cssClass="col-md-8 col-md-offset-2">
            ...
            <div class="form-group">
                <label for="hours">Утвержденный срок (дней)</label>
                <form:input id="hours"
            ...
            <div class="form-group">
                <label for="special">Галочка</label>
