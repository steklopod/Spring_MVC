package ru.manager.mvc.data.entities;
...
public class Project {
	...
	public String toString() {
		return "Проект [N=" + projectId + ", название=" + name
				+ ", описание=" + description + ", заказчик=" + sponsor
				+ ", срок=" + authorizedHours + ", бюджет="
				+ authorizedFunds + ", год=" + year + ", дополнительно=" + special
				+ ", тип=" + type + ", контакт=" + pointsOfContact
				+ ", начало=" + startDate + "]";
	}
